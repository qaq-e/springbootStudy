...
import com.zk.springbootzk.demos.dao.TuserDao;
...
// 给该用户设置角色，角色信息存在t_role表中取
        authorizationInfo.setStringPermissions(tuserDao.getPermissions(username));
        authorizationInfo.setRoles(tuserDao.getRoles(username));
    ...
    protected AuthenticationInfo doGetAuthenticationInfo(AuthenticationToken authenticationToken) throws AuthenticationException {
        ...
        T_user user = tuserDao.getByUsername(username);
        if(user != null) {
// 把当前用户存到session中
